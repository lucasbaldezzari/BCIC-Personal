...
from fileAdmin import csvGenerator
...
class Graph:
    def __init__(self, board_shim):
        ...
        self.exg_channels = BoardShim.get_exg_channels(self.board_id)[:9]
    ...
    def _init_band_plot(self):
        ...
        self.band_plot.setTitle('BandPower')
        y = [0, 0, 0, 0, 0]
        x = [1, 2, 3, 4, 5]
    ...
    def update(self):
        ...
        for count, channel in enumerate(self.exg_channels):
            ...
            DataFilter.perform_bandpass(data[channel], self.sampling_rate, 8.0, 36.0, 4,
...
def main():
    ...
    #genero mi archivo csv con mis datos de eeg

    filename = "eeg_sujeto1_trial1_target1.csv"
    csvGenerator(path ="dataset", subject = 2, trial = 1, target = 1, filename = filename)
    ...
    parser.add_argument('--board-id', type=int, help='board id, check docs to get a list of supported boards',
                        required=False, default=BoardIds.SYNTHETIC_BOARD)#SYNTHETIC_BOARD PLAYBACK_FILE_BOARD
    parser.add_argument('--file', type=str, help='file', required=False, default=filename)
    ...
    try:
        ...
        # board_shim.start_stream(1114, args.streamer_params)
        
        # board_shim.config_board ('loopback_true')
        # board_shim.config_board ('loopback_false')
        # board_shim.config_board ('new_timestamps')
        # board_shim.config_board ('old_timestamps')
        ...
        if board_shim.is_prepared():
            ...
            # print(get_eeg_channels(SYNTHETIC_BOARD))
...
#     parser.add_argument('--serial-port', type=str, help='serial port', required=False, default='')
#     parser.add_argument('--mac-address', type=str, help='mac address', required=False, default='')
#     parser.add_argument('--other-info', type=str, help='other info', required=False, default=-1)#BoardIds.SYNTHETIC_BOARD
#     parser.add_argument('--streamer-params', type=str, help='streamer params', required=False, default='')
#     parser.add_argument('--serial-number', type=str, help='serial number', required=False, default='')
#     parser.add_argument('--board-id', type=int, help='board id, check docs to get a list of supported boards',
#                         required=False, default=-3) #SYNTHETIC_BOARD PLAYBACK_FILE_BOARD
#     parser.add_argument('--file', type=str, help='file', required=False, default = "test.csv")
...
#     # board.start_stream(1114, args.streamer_params)
#     time.sleep(1)
